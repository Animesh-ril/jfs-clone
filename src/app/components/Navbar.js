      ...
      <div className="container mx-auto">
        <nav className="flex items-center justify-between flex-wrap p-6">
          ...
          <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden" id="nav-content">
            ...
            <div>
              <a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-gray-900 hover:bg-white mt-4 lg:mt-0">Download</a>
            </div>
          </div>
        </nav>
      </div>
